...
import type { Organization } from '@repo/auth/server';
...
export function OrganizationSwitcher() {
  ...
  const [showCreateOrganizationDialog, setShowCreateOrganizationDialog] =
    useState(false);
  const [changeOrganizationIsPending, setChangeOrganizationIsPending] =
    useState(false);
  ...
  const handleSelectOrg = async (organization: Organization) => {
    setChangeOrganizationIsPending(true);
    ...
    setChangeOrganizationIsPending(false);
  };
            ...
            >
              ...
              {organizations?.map((org) => (
                <DropdownMenuItem
                  ...
                  disabled={changeOrganizationIsPending}
                  className='gap-2 p-2'
                >
